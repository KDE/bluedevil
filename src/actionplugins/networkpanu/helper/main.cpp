...
{
    KAboutData aboutData("bluedevilnetworpanukhelper", "bluedevil", ki18n("Bluetooth Network PANU Helper"), "0.1", ki18n("Bluetooth Network PANU Helper"),
    KAboutData::License_GPL, ki18n("(c) 2010, UFO Coders"));

    aboutData.addAuthor(ki18n("Alejandro Fiestas Olivares"), ki18n("Developer"), "afiestas@kde.org",
