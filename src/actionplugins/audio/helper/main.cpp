...
{
    KAboutData aboutData("bluedevilaudiohelper", "bluedevil", ki18n("Bluetooth Audio Helper"), bluedevil_version, ki18n("Bluetooth Audio Helper"),
    ...
    AudioHelper *audioHelper = new AudioHelper(url);
